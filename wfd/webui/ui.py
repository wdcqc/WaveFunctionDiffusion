        ...
        with gr.Tab("txt2img"):
            with gr.Row():
                with gr.Column():
                    ...
                    wfc_guidance_start_step = gr.Slider(minimum=1, maximum=100, value=30, step=1, label="WFC guidance starting step")
        ...
        with gr.Tab("img2img"): # copypaste programming ftw
            with gr.Row():
                with gr.Column():
                    ...
                    i2i_wfc_guidance_start_step = gr.Slider(minimum=1, maximum=100, value=30, step=1, label="WFC guidance starting step")
