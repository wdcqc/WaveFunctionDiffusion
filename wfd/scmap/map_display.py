...
def process_tile_image(tileset, data_folder = "tile_data/"):
...
def process_tile_mapping(tileset, data_folder = "tile_data/"):
...
def demo_map_image(tile_result, wfc_data_path, random_subtiles=True, rare_prob = 0.05):
